...
const formSchema = z.object({
  ...
  service_type: z.enum(["plumbing", "electrical", "both", "borehole", "solar"], { required_error: "Please select a service type." }),
  urgency: z.enum(["routine", "this_week", "emergency"], { required_error: "Please select an urgency level." }),
